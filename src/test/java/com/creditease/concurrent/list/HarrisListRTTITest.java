...
public class HarrisListRTTITest extends TestCase {

    private final static int THREADS = 8;
    private final static int TEST_SIZE = 10240;
    private final static int PER_THREAD = TEST_SIZE / THREADS;
    HarrisListRTTI<Integer> instance;
    Thread[] thread = new Thread[THREADS];

    public HarrisListRTTITest(String testName) {
        super(testName);
        instance = new HarrisListRTTI<Integer>();
    }

    public static Test suite() {

        TestSuite suite = new TestSuite(HarrisListRTTITest.class);
